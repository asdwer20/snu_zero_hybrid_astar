...
def mainloop():
    ...
    rospy.loginfo("\n* Hello rospy log!\n")
    # qgoal2 = tf.transformations.quaternion_from_euler(0, 0, goalyaw)
    rospy.loginfo("qgoal: %s %s %s %s\n", qgoal[0], qgoal[1], qgoal[2], qgoal[3])
    # rospy.loginfo("qgoal2: %s %s %s %s\n", qgoal2[0], qgoal2[1], qgoal2[2], qgoal2[3])
    eugoal = tf.transformations.euler_from_quaternion([qgoal[0], qgoal[1], qgoal[2], qgoal[3]])
    rospy.loginfo("eugoal: %s %s %s\n", eugoal[0], eugoal[1], eugoal[2])
